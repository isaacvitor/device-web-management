    ...
    <div class="config-page">
      <div class="form">
        ...
        <form class="config-form" action="http://192.168.4.1/submit" method="post">
          <!-- Don't modified fields BELOW -->
          <input type="text" name="pAccessPointSSID" placeholder="Access Point SSID" />
          <input type="password" name="pAccessPointPassword" placeholder="Access Point SSID Password" />
          <input type="text" name="pStationSSID" placeholder="SSID" />
          <input type="password" name="pStationPassword" placeholder="SSID Password" />
          <!-- Don't modified fields ABOVE -->
          <!--custom fields-->
